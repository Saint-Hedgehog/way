...
(() => {
  ...
  // переход к подробной информации при клике на карточку
  ...
  cards.forEach((it) => {
    it.addEventListener('mousedown', onPlacesLinkClickTabOpen);
  });

  linksContainer.addEventListener('mousedown', onLinkClickTabOpen);
